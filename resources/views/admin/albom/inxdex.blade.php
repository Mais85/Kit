            ...
            <div class="u-mb-xsmall" style="float:right;">
                <div class="c-dropdown dropdown">
                    ...
                    <div class="c-dropdown__menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuToggleModal">
                        <a class="c-dropdown__item dropdown-item" href="javascript:;" onclick="massDelete('alboms')">Seçili Olanları Sil</a>
            ...
            <div class="c-table-responsive@wide">
                <table class="c-table">
                    ...
                    <tr class="c-table__row">
                        ...
                        <th class="c-table__cell c-table__cell--head">Albom adı</th>
                        <th class="c-table__cell c-table__cell--head">Şəkil sayı</th>
                        <th class="c-table__cell c-table__cell--head">Göstərilsin ?</th>
