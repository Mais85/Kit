            ...
            <div class="u-mb-xsmall" style="float:right;">
                <div class="c-dropdown dropdown">
                    ...
                    <div class="c-dropdown__menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuToggleModal">
                        <a class="c-dropdown__item dropdown-item" href="javascript:;" onclick="massDelete('services')">Seçili Olanları Sil</a>
            ...
            <div class="c-table-responsive@wide">
                <table class="c-table">
                    ...
                    <tr class="c-table__row">
                        ...
                        <th class="c-table__cell c-table__cell--head">Xidmətin adı</th>
                        <th class="c-table__cell c-table__cell--head">Xidməti təqdim edən şirkət</th>
                    ...
                    @foreach($items as $item)
                        <tr class="c-table__row">
                            ...
                            <th class="c-table__cell">{{$item->company_name}}</th>
